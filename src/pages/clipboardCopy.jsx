...
const ClipboardCopy = () => {
  ...
  // f: y => x * 2 -> where x is the pathLength of svg, y is the opacity
  // when pathLength is half target value, opacity is 100%
  ...
  return (
    <button
      ...
      className="self-center justify-self-center mx-auto"
